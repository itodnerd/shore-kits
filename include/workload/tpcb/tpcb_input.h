...
// microbenchmarks
const int XCT_TPCB_MBENCH_MIX = 0;
const int XCT_TPCB_MBENCH_INSERT_ONLY   = 1;
const int XCT_TPCB_MBENCH_DELETE_ONLY   = 2;
const int XCT_TPCB_MBENCH_PROBE_ONLY    = 3;
const int XCT_TPCB_MBENCH_INSERT_DELETE = 4;
const int XCT_TPCB_MBENCH_INSERT_PROBE  = 5;
const int XCT_TPCB_MBENCH_DELETE_PROBE  = 6;
